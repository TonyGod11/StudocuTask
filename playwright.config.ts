...
export default defineConfig({
  ...
  /* Reporter to use. See https://playwright.dev/docs/test-reporters */
    reporter: [
      ['line'],
      ['json', { outputFile: __dirname + '/output/test-results.json' }],
      ...
      ['html', { open: 'never', outputFolder: __dirname + '/output/report' }],
      ['junit', { outputFile: __dirname + '/output/TEST-results.xml' }],
      ['allure-playwright', { outputFolder: __dirname + '/output/allure-results' }],
    ],
